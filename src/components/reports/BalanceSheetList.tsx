...
export function BalanceSheetList({ title, totalValue, items, isAsset, plValue }: BalanceSheetListProps) {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {/* Container Principal */}
      <div className="bg-surface-light dark:bg-surface-dark rounded-[2.5rem] p-4 sm:p-6 shadow-soft border border-white/60 dark:border-white/5 relative overflow-hidden group">
